...
//use Jeanku\Database\Eloquent\Relations\Relation;
...
class Builder
{
     ...
     *
     * @var \Jeanku\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Jeanku\Database\Eloquent\Model
     */
    protected $model;
     ...
     * @param  \Jeanku\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Jeanku\Database\Eloquent\Model|\Jeanku\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Jeanku\Database\Eloquent\Model|\Jeanku\Database\Eloquent\Collection
     *
     * @throws \Jeanku\Database\Eloquent\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \Jeanku\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \Jeanku\Database\Eloquent\Model|static
     *
     * @throws \Jeanku\Database\Eloquent\ModelNotFoundException
     */
    ...
    {
        $models = $this->applyScopes()->getModels($columns);                    //1111
        if (count($models) > 0) {
     ...
     * @return \Jeanku\Database\Support\Collection
     */
     ...
     * @param  int|null  $page
     * @return \Jeanku\Database\Contracts\Pagination\LengthAwarePaginator
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Jeanku\Database\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \Jeanku\Database\Eloquent\Builder  $hasQuery
     * @param  \Jeanku\Database\Eloquent\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \Jeanku\Database\Eloquent\Builder|static
     ...
     *
     * @param  \Jeanku\Database\Eloquent\Builder  $relation
     * @return \Jeanku\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param  string  $relation
     * @return \Jeanku\Database\Eloquent\Relations\Relation
     */
    ...
    protected function addNestedWhereSlice(QueryBuilder $query, $wheres, $offset, $length = null)
    {
        ...
        $whereBooleans = $this->collect($whereSlice)->pluck('boolean');
